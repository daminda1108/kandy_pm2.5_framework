...
| 🔴 **W6** | **REOPENED 2026-08-22 (F.66)** — F.23 corroborated the vehicular **timing** (3.67× rush ratio) and said so; the **mass** share was never tested and is now measured at **traffic 7.6% / biomass 14.1%** (Seneviratne 2017 PMF, Katugastota). **Never restate "~90% vehicular".** | OPEN |
