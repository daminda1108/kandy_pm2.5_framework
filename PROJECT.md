...
| **Budget ladder — level axis** | 47 cities, 4 bands, 32 countries; +2 stn 16–38%, +6 stn ~0%, **+background 28–52%** | `scripts/modular_validation_all.py` (F.51) |
| **Background gain is REAL** | independent network 89 km away recovers **75%** of it | `scripts/independent_background.py` (F.54) |
...
| **Kandy product** | basin 21 µg/m³; 25% local / 75% regional ⚠; **427 [235–625] deaths/yr** on the shipped v3 tier (the older 425 [229–625] was v1-era; preprint aligned 2026-07-26) | additive_v3 field + `health_burden.py` |
